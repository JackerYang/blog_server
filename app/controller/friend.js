...
module.exports = {
    getFriendList: async ctx => {
        let res = await friend.getFriendList()
        ctx.send(res)
    },
    ...
    getFriendPage: async ctx => {
        ...
        let res = await friend.getFriendPage(req)
        ctx.send(res)
    },
    ...
    getFriend: async ctx => {
        ...
        let res = await friend.getFriend(req.id)
        ctx.send(res)
    },
